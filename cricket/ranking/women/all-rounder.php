<?php
    ...
    function postRequestCapture(){
        ...
        $html = file_get_html('https://www.cricbuzz.com/cricket-stats/icc-rankings/women/all-rounder',  false, $context);
        $test_array = array();
        $index_array = array();
        $img2="";
        $index = 1;
        ...
        $object = array('index'=>$index_array, 'all-rounder'=>$test_array);
